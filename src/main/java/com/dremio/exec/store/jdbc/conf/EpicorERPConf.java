...
@SourceType(value = "EpicorERPARP", label = "EpicorERP",uiConfig = "epicorerp-layout.json")
public class EpicorERPConf extends AbstractArpConf<EpicorERPConf> {
  private static final String ARP_FILENAME = "arp/implementation/epicorerp-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.epicorerp.EpicorERPDriver";
